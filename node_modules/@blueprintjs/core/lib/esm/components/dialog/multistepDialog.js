...
var MultistepDialog = /** @class */ (function (_super) {
    ...
    MultistepDialog.prototype.renderButtons = function () {
        ...
        if (this.state.selectedIndex > 0) {
            buttons.push(React.createElement(Button, { key: "back", onClick: this.getBackClickHandler(), text: "Back" }));
        }
        if (this.state.selectedIndex === this.getDialogStepChildren().length - 1) {
            buttons.push(this.renderFinalButton());
        }
        else {
            buttons.push(React.createElement(Button, __assign({ intent: "primary", key: "next", onClick: this.getNextClickHandler(), text: "Next" }, this.props.nextButtonProps)));
        }
        return buttons;
    };
    ...
    MultistepDialog.prototype.renderFinalButton = function () {
        return React.createElement(Button, __assign({ intent: "primary", key: "final", text: "Submit" }, this.props.finalButtonProps));
    };
