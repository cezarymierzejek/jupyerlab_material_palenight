...
var MultistepDialog = /** @class */ (function (_super) {
    ...
    MultistepDialog.prototype.renderButtons = function () {
        ...
        if (this.state.selectedIndex > 0) {
            buttons.push(React.createElement(buttons_1.Button, { key: "back", onClick: this.getBackClickHandler(), text: "Back" }));
        }
        if (this.state.selectedIndex === this.getDialogStepChildren().length - 1) {
            buttons.push(this.renderFinalButton());
        }
        else {
            buttons.push(React.createElement(buttons_1.Button, tslib_1.__assign({ intent: "primary", key: "next", onClick: this.getNextClickHandler(), text: "Next" }, this.props.nextButtonProps)));
        }
        return buttons;
    };
    MultistepDialog.prototype.getBackClickHandler = function () {
        return this.getDialogStepChangeHandler(this.state.selectedIndex - 1);
    };
    MultistepDialog.prototype.getNextClickHandler = function () {
        return this.getDialogStepChangeHandler(this.state.selectedIndex + 1);
    };
    ...
    MultistepDialog.prototype.renderFinalButton = function () {
        return React.createElement(buttons_1.Button, tslib_1.__assign({ intent: "primary", key: "final", text: "Submit" }, this.props.finalButtonProps));
    };
