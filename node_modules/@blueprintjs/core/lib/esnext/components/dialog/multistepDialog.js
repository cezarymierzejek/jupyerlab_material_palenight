...
let MultistepDialog = class MultistepDialog extends AbstractPureComponent2 {
    ...
    renderButtons() {
        ...
        if (this.state.selectedIndex === this.getDialogStepChildren().length - 1) {
            ...
            buttons.push(React.createElement(Button, Object.assign({ intent: "primary", key: "next", onClick: this.getNextClickHandler(), text: "Next" }, this.props.nextButtonProps)));
        }
        return buttons;
    }
    getBackClickHandler() {
    ...
    renderFinalButton() {
        return React.createElement(Button, Object.assign({ intent: "primary", key: "final", text: "Submit" }, this.props.finalButtonProps));
    }
